...
- Generate & stores JSON files from these timesheets
...
| QG3 | Extensibility   | The effort to add new target formats for the timesheets should be as low as possible. The effort to deploy to additional hyperscalers should be as low as possible. The effort to use various web frameworks (e.g. Spring Boot, Quarkus, ...) should be as low as possible |
